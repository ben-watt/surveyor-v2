...
interface StoreOperations {
  ...
  reorderEntity: (entityType: EntityType, entityId: string, newOrder: number) => Promise<void>;
  ...
  bulkMove: (entityType: EntityType, entityIds: string[], newParentId: string) => Promise<void>;
...
const rebalanceOrders = async (entities: Entity[]): Promise<void> => {
