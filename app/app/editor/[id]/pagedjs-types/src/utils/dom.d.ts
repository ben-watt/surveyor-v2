export function isElement(node: any): any;
export function isText(node: any): any;
export function walk(start: any, limiter: any): Generator<any, void, unknown>;
export function nodeAfter(node: any, limiter: any): Node | undefined;
export function nodeBefore(node: any, limiter: any): Node | undefined;
export function elementAfter(node: any, limiter: any): Node | undefined;
export function elementBefore(node: any, limiter: any): Node | undefined;
export function displayedElementAfter(node: any, limiter: any): Node | undefined;
export function displayedElementBefore(node: any, limiter: any): Node | undefined;
...
export function indexOf(node: any): number;
