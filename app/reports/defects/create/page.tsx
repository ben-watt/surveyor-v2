        ...
        <div className="container mx-auto px-5">
            ...
            <FormProvider {...form}>
                <form onSubmit={handleSubmit(onSubmit)}  className="grid gap-4">
                    <InputText labelTitle="Name" register={() => register("name", { required : true })} />
                    <TextAreaInput labelTitle="Description" placeholder="Description" register={() => register("description")} />
                    <TextAreaInput labelTitle="Casuse" placeholder="Cause" register={() => register("cause")} />
                    <SelectBox labelTitle="Element" register={() => register("element", { required : true })}>
                        <option value="1">Walls</option>
                        <option value="2">Floor</option>
                        <option value="3">Ground</option>
                    </SelectBox>
                    <SelectBox labelTitle="Component" register={() => register("component", { required : true })}>
