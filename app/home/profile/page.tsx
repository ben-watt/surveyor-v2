...
function Page() {
  ...
  const saveProfile = async (data: ProfileFormData, { auto = false }: { auto?: boolean } = {}) => {
    ...
    const debounceToast = debounce(() => {
      if (!auto) {
        toast.success(
          'Profile updated successfully. You may need to log out and log back in to see the changes.',
        );
      }
    }, 1000);
          ...
          try {
            ...
            switch (nextStep.updateAttributeStep) {
              case 'CONFIRM_ATTRIBUTE_WITH_CODE':
                ...
                if (!auto) {
                  toast(`Confirmation code was sent to ${codeDeliveryDetails?.deliveryMedium}.`);
                }
    ...
    <div className="min-h-screen bg-white">
      <div className="relative z-10 py-8">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="rounded-2xl border-0 bg-white/95 p-8 shadow-md backdrop-blur-sm">
