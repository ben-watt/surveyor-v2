...
describe("buildSections", () => {
  ...
  const elements = [
    { id: "e2", name: "Element 2", order: 2, sectionId: "s1", description: "", updatedAt: "", syncStatus: "synced", tenantId: "t" },
    { id: "e1", name: "Element 1", order: 1, sectionId: "s1", description: "", updatedAt: "", syncStatus: "synced", tenantId: "t" },
    { id: "e3", name: "Element 3", order: 1, sectionId: "s2", description: "", updatedAt: "", syncStatus: "synced", tenantId: "t" },
  ] as any;
