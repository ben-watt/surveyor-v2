...
import { checklistSchema, ChecklistInput, updateChecklistStatus } from '../../schemas';
    ...
    <div>
      ...
      {isHydrated && survey && (
        <DynamicDrawer
          ...
          title="Checklist"
          content={<ChecklistForm id={id} initValues={survey.checklist} surveyData={survey} />}
        />
      )}
    </div>
  );
