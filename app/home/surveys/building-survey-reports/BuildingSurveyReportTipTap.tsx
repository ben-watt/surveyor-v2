    ...
    <>
      ...
      <Page>
        ...
        <TableBlock widths={[94, 6]}>
          <ul>
            <li>
              For information purposes, generally, no repair is required. Property to be maintained
              as usual.
            </li>
          </ul>
          ...
          <ul>
            <li>
              Defects requiring repair/replacement but not considered urgent nor serious. Property
          ...
          <ul>
            <li>
              Serious defects to be fully considered prior to purchase that need to be repaired,
      ...
      <Page>
        ...
        <TableBlock widths={[10, 90]}>
          ...
          <p style={{ textAlign: 'justify' }}>
            ...
            energy efficiency and thermal improvement, which will assist in potentially reducing
            heating expenditure. The property is currently listed as achieving a rating of 58 (D),
            with the potential to achieve 78 (C). We recommend reviewing the EPC Certificate and
          ...
          <p style={{ textAlign: 'justify' }}>
            ...
            2020. This report does not provide extended advice on Minimum Energy Efficiency
            Standards (MEES) Regulations (2015) and is not designed to be used as evidence for the
            PRS Exemption Register. The responsibility for complying with MEES is allocated to the
            landlord and/or owner of the property.
          </p>
        </TableBlock>
      </Page>
      <Page>
...
Board's website. We have not undertaken any separate inquiries with the relevant statutory authority.`}
      ...
      <Page>
        ...
        <TableBlock widths={[10, 90]}>
          ...
          <p style={{ textAlign: 'justify' }}>
            ...
            and a lack of air vents to the original subfloor void.. These issues need to be
            addressed to ensure the longevity of the property and to prevent more costly repairs in
            the long term.
          </p>
          <h3>&nbsp;</h3>
          <p style={{ textAlign: 'justify' }}>
        ...
        <p>
          We trust this Report is satisfactory for your present requirements and if you wish to
          discuss matters further, please contact:
        </p>
        <p>
      ...
      <Page>
        ...
        <TableBlock widths={[10, 90]}>
          ...
          <p style={{ textAlign: 'justify' }}>
            ...
            concealed or to remove surface finishes for the examination of underlying elements. As
            such, we are unable to confirm that inaccessible and concealed parts of the property are
            free from defects.
          </p>
        </TableBlock>
        <TableBlock widths={[10, 90]}>
          ...
          <p style={{ textAlign: 'justify' }}>
            ...
            recommendations where we believe that tests should be carried out and made a brief
            comment where something has been found from a visual inspection to be obviously
            defective.
          </p>
        </TableBlock>
        <TableBlock widths={[10, 90]}>
        ...
        <TableBlock widths={[10, 90]}>
          ...
          <p style={{ textAlign: 'justify' }}>
            ...
            investigations may reveal additional works and thus greater expenditure. The costs are
            subject to a competitively sought tender process and are intended for budgeting purposes
            only. All costs provided are exclusive of VAT, professional fees and access unless
            expressly stated.
          </p>
        </TableBlock>
        <TableBlock widths={[10, 90]}>
      ...
      <Page>
        ...
        <p style={{ textAlign: 'justify' }}>
          ...
          where it is safe to do so. We inspect the roof structure from inside the roof space if
        ...
        <p style={{ textAlign: 'justify' }}>
          ...
          owner's consent. Intermittent faults of services may not be apparent on the day of
          inspection.
        </p>
        <p></p>
        <p style={{ textAlign: 'justify' }}>
          ...
          recommendations on how these repairs should be carried out. Some maintenance and repairs
          we suggest may be expensive. Purely cosmetic and minor maintenance defects that do not
          affect performance might not be reported. The report that we provide is not a warranty.
        </p>
      </Page>
    </>
  );
