/**
 * Form utility functions for building survey reports
 * 
 * Provides React component helpers for mapping input types to form components.
 */
...
/**
 * Maps input configuration to the appropriate React form component
 * 
 * @param input - Input configuration object
 * @param registerName - Form field registration name
 * @param register - React Hook Form register function
 * @param control - React Hook Form control object
 * @param errors - Form validation errors
 * @returns JSX element for the appropriate input component
 */
