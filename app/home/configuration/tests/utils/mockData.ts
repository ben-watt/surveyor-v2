...
export const createMockStores = () => ({
  sectionStore: {
    ...
    useGet: jest
      .fn()
      .mockImplementation((id: string) => [true, mockSections.find((s) => s.id === id) || null]),
  ...
  elementStore: {
    ...
    useGet: jest
      .fn()
      .mockImplementation((id: string) => [true, mockElements.find((e) => e.id === id) || null]),
    delete: jest.fn().mockResolvedValue({ isOk: true, value: 'deleted' }),
    isHydrated: true,
  },
  componentStore: {
    ...
    useGet: jest
      .fn()
      .mockImplementation((id: string) => [true, mockComponents.find((c) => c.id === id) || null]),
    delete: jest.fn().mockResolvedValue({ isOk: true, value: 'deleted' }),
    isHydrated: true,
  },
  phraseStore: {
    ...
    useGet: jest
      .fn()
      .mockImplementation((id: string) => [true, mockConditions.find((c) => c.id === id) || null]),
    delete: jest.fn().mockResolvedValue({ isOk: true, value: 'deleted' }),
    isHydrated: true,
  },
});
