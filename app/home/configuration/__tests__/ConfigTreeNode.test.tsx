...
describe('ConfigTreeNode', () => {
  ...
  describe('Rendering Tests', () => {
    ...
    it('should show/hide expand/collapse buttons based on children', () => {
      ...
      const { container: leafContainer } = render(<ConfigTreeNode {...defaultProps} node={mockConditionNode} level={3} />);
    ...
    it('should apply highlighting for recently edited entities', () => {
      ...
      const { container } = render(<ConfigTreeNode {...defaultProps} lastEditedEntity={lastEditedEntity} />);
  ...
  describe('Accessibility Tests', () => {
    it('should have proper ARIA labels', () => {
      ...
      const expandButton = container.querySelector('button svg.lucide-chevron-right')?.closest('button');
      expect(expandButton).toBeInTheDocument();
    });
  ...
  describe('Tree Structure Tests', () => {
    it('should render children when expanded', () => {
      ...
      render(<ConfigTreeNode {...defaultProps} node={expandedNode} expandedNodes={new Set(['section-1'])} />);
    ...
    it('should handle nested expansion correctly', () => {
      ...
      render(<ConfigTreeNode {...defaultProps} node={expandedSection} expandedNodes={expandedNodes} />);
