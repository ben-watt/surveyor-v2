...
const plugin = ({ addFilter, utils, views }) => {
  ...
  return {
    ...
    options: {
      ...
      metadataEditIcon: [
        '<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><path d="M7 17h12a1 1 0 0 0 0-2H7a1 1 0 1 0 0 2zM7 13h12a1 1 0 0 0 0-2H7a1 1 0 1 0 0 2zM7 9h12a1 1 0 0 0 0-2H7a1 1 0 1 0 0 2z" fill="currentColor" fill-rule="nonzero"/></svg>',
        Type.STRING
      ]
    }
  };
